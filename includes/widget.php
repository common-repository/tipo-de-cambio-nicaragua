...
class tc_nicaragua_widget extends WP_Widget 
{
    ...
    ?>
        ...
        <div>
            <label for="<?php esc_attr_e($this->get_field_id('tc_nicaragua_detalle')); ?>"><b><?php _e('Informaci�n detallada (ayer, ma�ana y promedio)', 'tipo-de-cambio-nicaragua'); ?>:</b></label><br>
            <?php $v_detalle = 1; ?>
